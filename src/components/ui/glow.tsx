  ...
  >
    <div
      className={cn(
        ...
        "absolute left-1/2 h-[256px] w-[60%] -translate-x-1/2 scale-[2.5] rounded-[50%] bg-[radial-gradient(ellipse_at_center,_var(--brand-foreground)_10%,_transparent_60%)] sm:h-[512px]",
    ...
    <div
      className={cn(
        ...
        "absolute left-1/2 h-[128px] w-[40%] -translate-x-1/2 scale-[2] rounded-[50%] bg-[radial-gradient(ellipse_at_center,_var(--brand)_0%,_transparent_60%)] sm:h-[256px]",
        variant === "center" && "-translate-y-1/2",
      )}
    />
  </div>
