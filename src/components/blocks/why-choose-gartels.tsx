...
const features = [
  {
    ...
    description: 'Our springs exceed industry standards with rigorous quality control and premium materials.'
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: 'We engineer springs to your exact specifications, ensuring perfect performance for your application.'
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: 'Rapid prototyping and efficient manufacturing processes for quick delivery when you need it most.'
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: 'Comprehensive testing ensures your springs meet or exceed performance requirements.'
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Our engineering team provides ongoing technical support for the lifetime of your product.'
  }
];
