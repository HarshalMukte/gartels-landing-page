      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            >
              <div className="relative min-h-[300px] max-h-[450px] flex size-full max-w-lg justify-center items-center overflow-hidden rounded-lg border bg-background px-40 pb-20 pt-4 md:pb-60 md:shadow-xl">
